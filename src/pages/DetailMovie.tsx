...
export default class DetailMovie extends Component<PropsType, StateType> {
  ...
  fetchData() {
    fetch(`https://api.themoviedb.org/3/movie/683328?api_key=${import.meta.env.VITE_API_KEY}&language=en-US`, { method: "GET" })
        ...
        {this.state.loading ? (
          ...
          <div className="flex w-full h-[50vh] bg-gray-500">
            ...
            <div className="p-5">
              ...
              <p>Release Date: {moment(this.state.data.release_date).format("DD MMMM YYYY")}</p>
